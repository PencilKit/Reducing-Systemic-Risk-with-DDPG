    ...
    if do_leverage_results == True:
        ...
        for n in n_ind:
            ...
            for weight_func in lev_policy_dict[n].keys():
                ...
                avg_high_dr, avg_low_dr, std_high_dr, std_low_dr = ar.average_dr(
                    n,
                    1,
                    number_of_episodes,
                ...
                save_leverage_data[weight_func] = {
                    "average_high_dr": avg_high_dr,
                    "avg_low_dr": avg_low_dr,
                    "std_high_dr": std_high_dr,
                    "std_low_dr": std_low_dr
                }
        ...
        with open(out_path + "/leverage_dictionary10.pkl", "wb") as f:
            pickle.dump(save_leverage_data, f)
